...
const Blogs = () => {
    return (
        <div className='mx-10 grid grid-cols-1 md:grid-cols-2 gap-x-8'>
            <div className='border shadow-lg p-6'>
                <h1><span className='font-bold'>Question-1:</span> What is Context API?  Explain purpose of context API.</h1>
            ...
            <div className='border shadow-lg p-6'>
                <h1><span className='font-bold'>Question-2:</span> Difference between inline and block elements</h1>
                <h1><span className='font-bold'>Answer:</span>
                    ...
                    <div className='grid grid-cols-2 gap-2 '>
                        <div className='border-2 p-3 mt-2'>
                            ...
                            <p>02. Inline elements allow other inline elements to sit behind.</p> <br />
                            <p>03. Inline elements don't have top and bottom margin </p>
                        </div>

                        <div className='border-2 p-3 mt-2'>
                            <p>01. Block elements always start in a line.</p><br />
                            <p>02. Block elements doesn't allow other elements to sit behind</p><br />
                            <p>03. Block elements have top and bottom margin.</p>
                        </div>
